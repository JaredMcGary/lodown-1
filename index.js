...
/*
identity: designed to return anything that is passed into it
@param: (anything): is just a value
*/
...
/*
typeOf: designed to return the type of value/datatype
@param: value: is any dataType that is passed
*/
...
*/
  ...
  /*
first: designed to return an array if it is not an array
else if there is no number or it wasnt givin it will return just the first element
else its going to rturn the first number items in the array
@param: (array): is a place holder for an array
@param: (number): is a place holder for an number
*/
  
   function first(array, number){ //input of array and number
...
*/
  ...
  /*
last: designed to return the last number itms in an array
@param: (array): placeholder for an array []
@param: (number): placeholder for a number
*/
...
if the value isn't in the array its going to return -1
@param: (array): a placeholder for an array []
@pram: (value): a placeholder for a value;
*/
...
*/
 ...
 function unique(array) {
  function funky(value, index, self) { 
      return self.indexOf(value) === index;
  }

  // usage
  var unique = array.filter( funky ); // returns ['a', 1, 2, '1']
...
// 	     var result = action(currentValue, index, array)
//      if (result === true) {
...
function some(collection, test){
 let trueOrFalse = false;
    (collection, function(element, index, collection) {
